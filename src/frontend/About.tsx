    ...
    return (
        <>
            <div className='bg-white'>
                ...
                <div className=" container mx-auto flex my-[50px]">
                    <div className="w-1/2 sm:1/1">
                        <img
                    ...
                    <div className="w-1/2 p-8">
                        ...
                        <p className="text-gray-600">
                            Your text goes here. Customize this area with your content.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                    ...
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3">
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img class="rounded-t-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" width={1000} alt="" />
                            </a>
                            <div class="p-5">
                                <a href="#">
                                ...
                                <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#ffc000] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Read more
